        ...
        if (glErr != GL_NO_ERROR) {
			...
			*/
            ...
            case GL_INVALID_ENUM:
                myerror = "invalid enumerant";
            case GL_INVALID_VALUE:
                myerror = "invalid value";
            case GL_INVALID_OPERATION:
                myerror = "invalid operation";
#ifndef GL_ES_VERSION_2_0
            case GL_STACK_OVERFLOW:
                myerror = "stack overflow";
            case GL_STACK_UNDERFLOW:
                myerror = "stack underflow";
#endif
            case GL_OUT_OF_MEMORY:
                myerror = "out of memory";
            case GL_TABLE_TOO_LARGE:
                myerror = "table too large";
            case GL_INVALID_FRAMEBUFFER_OPERATION:
                myerror = "invalid framebuffer operation";
            case GL_TEXTURE_TOO_LARGE:
                myerror = "texture too large";
            default:
                myerror = "unknown GL error";
            }

            printf("glError in file %s @ line %d: %s Error Number: %d\n",
                "SHADRER.H", 111, myerror, glErr);
            retCode = 1;
        }
