...
public:
    ...
    bool Run_method3(double a, double b, double c, double d, double l, double m, double n, double k, double p, double q, double r, double s, double& x, double& y, double& z);
};
